...
tailShape.moveTo(0.05, 0);        // connect slightly inside body
...
const extrudeSettings = {
  depth: 0.05,          // thickness of the tail
  bevelEnabled: false  // keep edges sharp
};
...
tail.position.x = -0.7;       // connect to body
